...
'''Модель - это класс, который наследуется от models.Model и представляет таблицу в базе данных.'''

'''---------------------------------ДЗ 2. Работа с моделями---------------------------------'''
'''
Поля модели «Клиент»:
— имя клиента
...
# также создать comands.py в папке myapp и добавить туда команды для работы с моделями
