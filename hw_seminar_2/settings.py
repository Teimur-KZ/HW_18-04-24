"""
Django settings for hw_seminar_2 project.
...
SECRET_KEY = 'django-insecure-8*#u&3=6o*a4vt9785k^4%*fg)2ry_db(%aqg(##t*ne30m!!m'
...
ROOT_URLCONF = 'hw_seminar_2.urls'
...
WSGI_APPLICATION = 'hw_seminar_2.wsgi.application'
